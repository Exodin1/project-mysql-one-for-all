...
CREATE TABLE plano (
	  plano_id INTEGER AUTO_INCREMENT primary key,
...
CREATE TABLE artistas (
    artista_id INTEGER AUTO_INCREMENT PRIMARY KEY,
    nome VARCHAR (100) NOT NULL
) 	engine = InnoDB;
...
INSERT INTO albums (nome, artista_id, release_year)
...
CREATE TABLE seguindo_artistas (
    ...
    seguindo_artista_id INTEGER NOT NULL,
...
INSERT INTO seguindo_artistas (usuario_id, seguindo_artista_id)
  VALUES      (1, 1),
              (1, 3),
              (1, 4),
              (2, 1),
...
CREATE TABLE cancoes (
    cancao_id INTEGER AUTO_INCREMENT primary key,
    nome VARCHAR (70) NOT NULL,
